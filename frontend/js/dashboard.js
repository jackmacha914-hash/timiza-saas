...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadDashboardStats() {
        ...
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/stats');
    ...
    async function fetchAccounts() {
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/accounts');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (clubForm && clubNameInput && advisorInput) {
            clubForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const res = await authFetch('https://school-management-system-av07.onrender.com/api/clubs', {
                        method: 'POST',
    ...
    async function fetchBooks() {
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/library/books');
    ...
    if (eventForm) {
        eventForm.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await authFetch('https://school-management-system-av07.onrender.com/api/events', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    document.getElementById('club-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await fetch('https://school-management-system-av07.onrender.com/api/clubs', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    document.getElementById('add-teacher-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/users/teachers', {
                method: 'POST',
    ...
    document.getElementById('add-student-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/users/students', {
                method: 'POST',
    ...
    document.getElementById('broadcast-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://school-management-system-av07.onrender.com/api/broadcast', {
                method: 'POST',
    ...
    document.getElementById('backup-btn')?.addEventListener('click', () => {
        window.location.href = 'https://school-management-system-av07.onrender.com/api/backup/download';
    });
