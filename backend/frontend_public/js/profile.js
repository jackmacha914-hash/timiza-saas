...
<<<<<<< HEAD
        photoUrl = photoUrl.replace(/^http:\/\/localhost(:\d+)?/, window.API_CONFIG?.BASE_URL || 'https://timiza-saas.onrender.com');
=======
...
<<<<<<< HEAD
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://timiza-saas.onrender.com'}${data.profile.photo}`;
          } else if (!data.profile.photo.startsWith('http')) {
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://timiza-saas.onrender.com'}/uploads/${data.profile.photo}`;
=======
...
async function changePassword() {
  ...
  try {
<<<<<<< HEAD
    const response = await fetch("https://timiza-saas.onrender.com/api/profile/change-password", {
=======
