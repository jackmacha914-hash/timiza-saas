...
<<<<<<< HEAD
        photoUrl = photoUrl.replace(/^http:\/\/localhost(:\d+)?/, window.API_CONFIG?.BASE_URL || 'https://luckyjuniorschool.onrender.com');
=======
...
<<<<<<< HEAD
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://luckyjuniorschool.onrender.com'}${data.profile.photo}`;
          } else if (!data.profile.photo.startsWith('http')) {
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://luckyjuniorschool.onrender.com'}/uploads/${data.profile.photo}`;
=======
...
async function changePassword() {
  ...
  try {
<<<<<<< HEAD
    const response = await fetch("https://luckyjuniorschool.onrender.com/api/profile/change-password", {
=======
